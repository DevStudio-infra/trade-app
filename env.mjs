...
export const env = createEnv({
  server: {
    ...
    CRON_JOB_API_KEY: z.string().min(1),
  },
  client: {
    NEXT_PUBLIC_APP_URL: z.string().min(1),
    NEXT_PUBLIC_STRIPE_PRO_MONTHLY_PLAN_ID: z.string().min(1),
    NEXT_PUBLIC_STRIPE_PRO_YEARLY_PLAN_ID: z.string().min(1),
    NEXT_PUBLIC_STRIPE_FREE_CREDITS_PRICE_ID: z.string().min(1),
    NEXT_PUBLIC_STRIPE_PRO_CREDITS_PRICE_ID: z.string().min(1),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_FREE_CREDITS_PRICE_ID:
      process.env.NEXT_PUBLIC_STRIPE_FREE_CREDITS_PRICE_ID,
